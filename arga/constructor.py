...
def format_data(data_name, folder_name, hop_count):
    # Load data
    ...
    # Author: Tonni 
    with open('../../../../graph-data/{}/Processed/{}_features_hop_{}.pickle'.format(folder_name, data_name, str(hop_count)), 'rb') as handle: features = pickle.load(handle) 
    with open('../../../../graph-data/{}/Processed/{}_adj_hop_{}.pickle'.format(folder_name, data_name, str(hop_count)), 'rb') as handle: adj = pickle.load(handle)

    # if data_name == 'ArtificialV4': 
    #     f, a = 'pickles/' + data_name + '_features_hop_' + str(hop_count) + '.pickle', 'pickles/' + data_name + '_adj_hop_' + str(hop_count) + '.pickle'
    #     with open(f, 'rb') as handle: features = pickle.load(handle) 
    #     with open(a, 'rb') as handle: adj = pickle.load(handle)
