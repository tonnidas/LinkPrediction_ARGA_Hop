...
def get_settings(dataname, model, task, folder_name, hop_count):
    ...
    if task == 'clustering':
        ...
        re = {'data_name': dataname, 'iterations' : iterations, 'clustering_num' :clustering_num, 'model' : model, 'folder_name' : folder_name, 'hop_count' : hop_count}
    elif task == 'link_prediction':
        iterations = 4 * FLAGS.iterations
        re = {'data_name': dataname, 'iterations' : iterations,'model' : model, 'folder_name' : folder_name, 'hop_count' : hop_count}
