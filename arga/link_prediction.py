...
class Link_pred_Runner():
    def __init__(self, settings):
        ...
        self.folder_name = settings['folder_name']                      # Author: Tonni
    ...
    def erun(self):
        ...
        # formatted data
        feas = format_data(self.data_name, self.folder_name, self.hop_count)             # Updated with self.folder_name and hop_count
